...
const HomesTable = () => {
  const requests = [
    { id: 'REQ-2024-028', name: 'محمد خالد', phone: '+962 79 123 4567', addr: 'حي الياسمين - شارع 8 المنزل رقم 25', type: 'بلاستيك', typeColor: 'text-blue-600 bg-blue-50 border-blue-100', weight: '15 كجم', time: '08:45 AM', status: 'قيد الانتظار', statusColor: 'bg-amber-50 text-amber-600 border-amber-100' },
    { id: 'REQ-2024-027', name: 'سارة أحمد', phone: '+962 79 234 5678', addr: 'حي الزهور - شارع 12 المنزل رقم 47', type: 'ورق', typeColor: 'text-emerald-600 bg-emerald-50 border-emerald-100', weight: '20 كجم', time: '09:30 AM', status: 'في الطريق', statusColor: 'bg-blue-50 text-blue-600 border-blue-100' },
    { id: 'REQ-2024-026', name: 'أحمد علي', phone: '+962 79 345 6789', addr: 'حي النور - شارع 5 المنزل رقم 16', type: 'زجاج', typeColor: 'text-purple-600 bg-purple-50 border-purple-100', weight: '12 كجم', time: '09:45 AM', status: 'في الطريق', statusColor: 'bg-blue-50 text-blue-600 border-blue-100' },
    { id: 'REQ-2024-025', name: 'ليلى محمود', phone: '+962 79 456 7890', addr: 'حي الحدائق - شارع 3 المنزل رقم 9', type: 'مختلط', typeColor: 'text-amber-600 bg-amber-50 border-amber-100', weight: '18 كجم', time: '08:15 AM', status: 'مكتمل', statusColor: 'bg-emerald-50 text-emerald-600 border-emerald-100' },
    { id: 'REQ-2024-024', name: 'خالد مصطفى', phone: '+962 79 567 8901', addr: 'حي الجامعة - شارع 10 المنزل رقم 33', type: 'إلكترونيات', typeColor: 'text-red-600 bg-red-50 border-red-100', weight: '10 كجم', time: '10:00 AM', status: 'قيد الانتظار', statusColor: 'bg-amber-50 text-amber-600 border-amber-100' },
    { id: 'REQ-2024-023', name: 'نور الدين', phone: '+962 79 678 9012', addr: 'حي الياسمين - شارع 6 المنزل رقم 19', type: 'بلاستيك', typeColor: 'text-blue-600 bg-blue-50 border-blue-100', weight: '25 كجم', time: '07:50 AM', status: 'مكتمل', statusColor: 'bg-emerald-50 text-emerald-600 border-emerald-100' },
  ];
