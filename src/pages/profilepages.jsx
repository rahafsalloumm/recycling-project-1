...
import ProfileHeader from '../user/components/profile/profileheader'
import AccountActions from '../user/components/profile/accountactions'
import ActivityList from '../user/components/profile/activitylist'
import AccountInfoCard from '../user/components/profile/accountinfocard'
import SupportCard from '../user/components/profile/supportcard'
...
export default function ProfilePage() {
  ...
  const user = {
    ...
    activities: [
      ...
      { type: 'reward', icon: '⭐️', title: 'تم الحصول على نقاط مكافأة', description: 'تم إضافة 50 نقطة إلى رصيدك', time: '09:15 AM', date: '18/05/2024' },
