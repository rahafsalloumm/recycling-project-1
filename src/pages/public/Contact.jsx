  ...
  useEffect(() => {
    const loadContactInfo = async () => {
      try {
        ...
        console.error("فشل تحميل معلومات التواصل:", error);
        setContactInfoError("تعذر تحميل معلومات التواصل");
      }
    };
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          <div className="bg-white p-6 rounded-2xl border border-gray-100 flex flex-col justify-between space-y-6 text-right shadow-sm">
              ...
              <div className="space-y-5">
                <div className="flex items-center gap-4 justify-end text-right group">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5 font-medium">
                      {contactInfo?.companyEmail || (contactInfoError ? "غير متوفر" : "جاري التحميل...")}
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-4 justify-end text-right group">
                  <div>
                    ...
                    <p className="text-gray-600 text-xs font-semibold mt-0.5" style={{ direction: 'ltr' }}>
                      {contactInfo?.companyPhone || (contactInfoError ? "غير متوفر" : "جاري التحميل...")}
                    </p>
                  </div>
                  <div className="w-8 h-8 bg-green-50 text-[#2E7D32] rounded-xl flex items-center justify-center flex-shrink-0">
                    <FaPhone size={12} />
                ...
                <div className="flex items-start gap-4 justify-end text-right group">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5 leading-relaxed">
                      {contactInfo?.companyAddress || (contactInfoError ? "غير متوفر" : "جاري التحميل...")}
                    </p>
                  </div>
            ...
            <div className="flex items-center gap-4 justify-end text-right group border-t border-gray-50 pt-4">
              <div>
                ...
                <p className="text-gray-500 text-xs mt-0.5 leading-relaxed font-medium">
                  {contactInfo?.workHours || (contactInfoError ? "غير متوفر" : "جاري التحميل...")}
                </p>
              </div>
              <div className="w-8 h-8 bg-green-50 text-[#2E7D32] rounded-xl flex items-center justify-center flex-shrink-0">
                <FaClock size={12} />
          ...
          <div className="md:col-span-2 bg-white p-7 rounded-2xl border border-gray-100 flex flex-col justify-between shadow-sm">
            <div>
              ...
              {submitError && (
                <div className="bg-red-50 text-red-600 p-3 rounded-xl mb-5 text-center text-xs font-semibold border border-red-100">
                  {submitError}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {errors.subject && <p className="text-red-500 text-[10px] mt-1 text-right">{errors.subject}</p>}
                  </div>
                </div>
