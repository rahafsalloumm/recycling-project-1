        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className="text-right mt-2">
              <Link 
                to="/forgot-password" 
                className="text-xs font-semibold text-green-700 hover:text-emerald-500 transition-colors"
              >
                هل نسيت كلمة المرور؟
              </Link>
            </div>
          ...
          <button
            ...
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-4 rounded-2xl font-bold hover:scale-[1.02] transition disabled:opacity-60 shadow-sm"
          >
